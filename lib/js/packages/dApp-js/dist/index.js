(() => {
  ...
  // src/ReefMobileInjected.ts
  var ReefMobileInjected_default = class {
    constructor(sendRequest5, sigKey) {
  ...
  // ../reef-mobile-js/src/jsApi/signing/FlutterSigner.ts
  var sendRequest4;
  var nextId = 0;
  var FlutterSigner = class {
    constructor(_sendRequest) {
  ...
  async function enable(origin) {
    ...
    return new ReefMobileInjected_default(sendDAppMessage, signingKey);
  }
  function inject() {
