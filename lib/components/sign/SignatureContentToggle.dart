...
class SignatureContentToggle extends StatelessObserverWidget {
  ...
  Widget build(BuildContext context) {
    return Observer(builder: (_) {
      ...
      return IndexedStack(
        index: displayIdx,
        children: [
          buildSignUI(context, signatureRequest, account),
          content
        ],
      );
    });
  ...
  Scaffold buildSignUI(BuildContext context, SignatureRequest? signatureRequest, StatusDataObject<ReefAccount>? account) {
    return Scaffold(
  ...
  Future<bool> _confirmSign(SignatureRequest signatureRequest, String password) =>ReefAppState.instance.signingCtrl.authenticateAndSign(signatureRequest, password);
