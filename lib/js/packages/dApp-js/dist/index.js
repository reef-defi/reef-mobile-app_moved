(() => {
  ...
  var FlutterJS = class {
    ...
    init(reefMobileChannelName, logIdentName, flutterSubscribeMethodName, apiReadyIdentName, apiTxSignIdentName, txSignatureConfirmationJsFnName, apiDappMsgIdentName, dAppMsgConfirmationJsFnName) {
    ...
    postToFlutterStream(subscriptionId, value, jsChannelName) {
      return window[jsChannelName || this.REEF_MOBILE_CHANNEL_NAME].postMessage(JSON.stringify({
        id: subscriptionId,
        value
      }));
    }
    flutterSignatureRequest(signatureIdent, value) {
      window[this.REEF_MOBILE_CHANNEL_NAME].postMessage(JSON.stringify({
        id: this.txSignMsgIdent,
        value: { signatureIdent, value }
      }));
    }
    flutterDAppMsgRequest(signatureIdent, value) {
      window[this.REEF_MOBILE_CHANNEL_NAME].postMessage(JSON.stringify({
        id: this.txDappMsgIdent,
        value: { signatureIdent, value }
      }));
    }
    initFlutterSignatureConfirmationBridge(apiTxSignIdentName, txSignatureConfirmationJsFnName) {
