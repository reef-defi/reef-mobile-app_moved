(() => {
  ...
  // ../../node_modules/@reef-defi/extension-inject/index.js
  function injectExtension(enable2, {
    name,
    version
  }) {
    ...
    windowInject.injectedWeb3[name] = {
      enable: (origin) => enable2(origin),
      version
    };
  }

  // ../flutter-js-bridge/src/FlutterConnector.ts
  var FlutterConnector = class {
    constructor(flutterJS, responseFnName, flutterJsRequestFn, responseMsgHandler) {
      this.handlers = {};
      this.idCounter = 0;
    ...
    sendMessage(messageType, request, subscriber) {
    ...
    receiveMessage(flutterRequestIdent, value) {
    ...
    registerResponseFn(flutterJS, responseFnName) {
      const self2 = this;
      window[responseFnName] = (flutterRequestIdent, value) => {
        self2.receiveMessage(flutterRequestIdent, value || null);
      };
    }
  };

  // ../flutter-js-bridge/src/dappFlutterResponseHandler.ts
  function dAppResponseMsgHandler(handlerObj, value) {
  ...
  // ../flutter-js-bridge/src/sendRequestDApp.ts
  var dAppSendRequestFn;
  var getDAppSendRequestFn = (flutterJS) => {
    if (!dAppSendRequestFn) {
      const fSignConnector = new FlutterConnector(flutterJS, flutterJS.DAPP_REQ_CONFIRMATION_JS_FN_NAME, flutterJS.sendFlutterDAppMsgRequest.bind(flutterJS), dAppResponseMsgHandler);
      dAppSendRequestFn = fSignConnector.sendMessage.bind(fSignConnector);
    }
    return dAppSendRequestFn;
  };

  // ../../node_modules/@reef-defi/extension-base/page/Accounts.js
  var sendRequest;
  var Accounts = class {
  ...
  // ../../node_modules/@reef-defi/extension-base/page/Metadata.js
  var sendRequest2;
  var Metadata = class {
    constructor(_sendRequest) {
      sendRequest2 = _sendRequest;
    }
    get() {
      return sendRequest2("pub(metadata.list)");
    }
    provide(definition) {
      return sendRequest2("pub(metadata.provide)", definition);
    }
  };
  ...
  // ../../node_modules/@reef-defi/x-global/index.js
  ...
  // ../../node_modules/@reef-defi/x-textencoder/fallback.js
  ...
  // ../../node_modules/@reef-defi/x-textencoder/browser.js
  var TextEncoder2 = typeof xglobal.TextEncoder === "undefined" ? TextEncoder : xglobal.TextEncoder;

  // ../../node_modules/@reef-defi/util/is/function.js
  function isFunction(value) {
    return typeof value === "function";
  }

  // ../../node_modules/@reef-defi/util/is/string.js
  function isString(value) {
    return typeof value === "string" || value instanceof String;
  }

  // ../../node_modules/@reef-defi/util/is/undefined.js
  function isUndefined(value) {
    return typeof value === "undefined";
  }

  // ../../node_modules/@reef-defi/util/assert.js
  ...
  // ../../node_modules/@reef-defi/util/array/range.js
  ...
  // ../../node_modules/@reef-defi/util/bn/bn.js
  var import_bn = __toESM(require_bn(), 1);

  // ../../node_modules/@reef-defi/util/is/hex.js
  ...
  // ../../node_modules/@reef-defi/util/hex/hasPrefix.js
  function hexHasPrefix(value) {
    return !!(value && isHex(value, -1, true) && value.substr(0, 2) === "0x");
  }

  // ../../node_modules/@reef-defi/util/hex/stripPrefix.js
  ...
  // ../../node_modules/@reef-defi/util/hex/toU8a.js
  ...
  // ../../node_modules/@reef-defi/util/is/buffer.js
  function isBuffer(value) {
    return typeof Buffer !== "undefined" && Buffer.isBuffer(value);
  }

  // ../../node_modules/@reef-defi/util/is/u8a.js
  function isU8a(value) {
    return value instanceof Uint8Array;
  }

  // ../../node_modules/@reef-defi/util/string/toU8a.js
  var encoder = new TextEncoder2();
  function stringToU8a(value) {
    return value ? encoder.encode(value.toString()) : new Uint8Array();
  }

  // ../../node_modules/@reef-defi/util/u8a/toU8a.js
  ...
  // ../../node_modules/@reef-defi/util/u8a/toHex.js
  var ALPHABET = arrayRange(256).map((n) => n.toString(16).padStart(2, "0"));
  ...
  // ../../node_modules/@reef-defi/util/format/formatDate.js
  ...
  // ../../node_modules/@reef-defi/util/is/bn.js
  function isBn(value) {
    return import_bn.default.isBN(value);
  }

  // ../../node_modules/@reef-defi/util/is/object.js
  function isObject(value) {
    return typeof value === "object";
  }

  // ../../node_modules/@reef-defi/util/logger.js
  var logTo = {
    debug: "log",
    error: "error",
    log: "log",
  ...
  // ../../node_modules/@reef-defi/extension-base/page/PostMessageProvider.js
  ...
  var PostMessageProvider = class {
    constructor(_sendRequest) {
      ...
      _classPrivateFieldBase(this, _eventemitter)[_eventemitter] = new import_eventemitter3.default();
      sendRequest3 = _sendRequest;
    }
    ...
    clone() {
      return new PostMessageProvider(sendRequest3);
    }
    async connect() {
    ...
    listProviders() {
      return sendRequest3("pub(rpc.listProviders)", void 0);
    }
    on(type, sub) {
    ...
    async send(method, params, subscription) {
      if (subscription) {
        ...
        const id2 = await sendRequest3("pub(rpc.subscribe)", {
          method,
          params,
          type
        }, (res) => {
        ...
        _classPrivateFieldBase(this, _subscriptions)[_subscriptions][`${type}::${id2}`] = callback;
        return id2;
      }
      return sendRequest3("pub(rpc.send)", {
        method,
        params
      });
    }
    async startProvider(key) {
      ...
      _classPrivateFieldBase(this, _eventemitter)[_eventemitter].emit("disconnected");
      const meta = await sendRequest3("pub(rpc.startProvider)", key);
      sendRequest3("pub(rpc.subscribeConnected)", null, (connected) => {
        _classPrivateFieldBase(this, _isConnected)[_isConnected] = connected;
        if (connected) {
          _classPrivateFieldBase(this, _eventemitter)[_eventemitter].emit("connected");
        } else {
          _classPrivateFieldBase(this, _eventemitter)[_eventemitter].emit("disconnected");
        }
        return true;
  ...
  // ../../node_modules/@reef-defi/extension-base/page/Signer.js
  ...
  var Signer = class {
    constructor(_sendRequest) {
      sendRequest4 = _sendRequest;
    }
    async signPayload(payload) {
      const id2 = ++nextId;
      const result = await sendRequest4("pub(extrinsic.sign)", payload);
    ...
    async signRaw(payload) {
      const id2 = ++nextId;
      const result = await sendRequest4("pub(bytes.sign)", payload);
      return _objectSpread(_objectSpread({}, result), {}, {
        id: id2
      });
    }
  ...
  // ../../node_modules/@reef-defi/extension-base/page/Injected.js
  var Injected_default = class {
    constructor(sendRequest5) {
      this.accounts = void 0;
      this.metadata = void 0;
      this.provider = void 0;
      this.signer = void 0;
      this.accounts = new Accounts(sendRequest5);
      this.metadata = new Metadata(sendRequest5);
      this.provider = new PostMessageProvider(sendRequest5);
      this.signer = new Signer(sendRequest5);
    }
  };

  // src/injectExtension.ts
  var sendDAppMessage;
  async function injectMobileExtension(flutterJS) {
  ...
  async function enable(origin) {
    ...
    return new Injected_default(sendDAppMessage);
  }
  function inject() {
  ...
  // ../flutter-js-bridge/src/FlutterJS.ts
  var FlutterJS = class {
