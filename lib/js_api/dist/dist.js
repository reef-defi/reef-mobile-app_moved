(() => {
  ...
  // service/flutterConnectService.ts
  var FlutterJS = class {
    init(reefMobileChannelName, logIdentName, flutterSubscribeMethodName) {
    ...
    registerMobileSubscriptionMethod(flutterSubscribeMethodName) {
      window[flutterSubscribeMethodName] = (observableRefName, subscriptionId) => {
        const obs = window[observableRefName];
  ...
  window["testObs"] = interval().pipe(map((value) => {
